...
public class ItemController : MonoBehaviour
{
    ...
    void SmoothlyRotate()
    {
        ...
        if (movement_Item_Parent.transform.localEulerAngles != itemRotation)
        {
            ...
            newRotation.z = Mathf.SmoothDampAngle(movement_Item_Parent.transform.localEulerAngles.z, itemRotation.z, ref currentVelocity, rotationTime, rotationSpeed * 1000);  //スムーズに回転させる
